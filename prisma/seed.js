...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var guest1ExternalId, guest2ExternalId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    guest1ExternalId = crypto.randomUUID();
                    return [4 /*yield*/, prisma.user.create({
                            data: {
                                externalId: guest1ExternalId,
                                name: '모니카',
                                email: "guest-".concat(guest1ExternalId, "@local"),
                                phone: '01098765432',
                ...
                case 1:
                    _a.sent();
                    guest2ExternalId = crypto.randomUUID();
                    return [4 /*yield*/, prisma.user.create({
                            data: {
                                externalId: guest2ExternalId,
                                name: '전혜선',
                                email: "guest-".concat(guest2ExternalId, "@local"),
                                phone: '01012345678',
